...
function slider({container,slide, nextArrow, prevArrow, totalCounter, currentCounter, wrapper, field}) {
    ...
    const slidesWtapper = document.querySelector(wrapper);
    const slidesField = document.querySelector(field);
    const width = window.getComputedStyle(slidesWtapper).width;
    let slideIndex = 1;
    let offset = 0;
    if (slides.length < 10) {
    ...
    slidesWtapper.style.overflow = 'hidden';
...
window.addEventListener('DOMContentLoaded', () => {
    ...
    Object(_modules_timer__WEBPACK_IMPORTED_MODULE_1__["default"])('.timer','2020-09-15');
